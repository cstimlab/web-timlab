...
<div class="container-fluid">
    <div class="row" style="padding-left: 5%; padding-right: 5%; padding-top:7%; padding-bottom: 3%;">
        ...
        <form action="/store_beli/{{Route::input('nama_barang')}}" method="POST" class="was-validated">
            {{csrf_field()}}  
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="jumlah" placeholder="" name="jumlah" required>
            </div>
            <div class="form-group">
